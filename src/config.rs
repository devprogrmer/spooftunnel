//! Configuration types for SpoofTunnel.
//!
...
pub enum TunnelProtocol {
    ...
    /// The SpoofTunnel payload rides inside a bare IPv4 packet with
    ...
    /// Ethernet Bridging or 0x0800 IPv4) before the SpoofTunnel payload.
...
pub struct Config {
    ...
    /// ICMP echo identifier used to distinguish SpoofTunnel control packets
...
fn default_tun_name() -> String { "spoof0".to_string() }
...
fn default_quic_server_name() -> String { "SpoofTunnel".to_string() }
